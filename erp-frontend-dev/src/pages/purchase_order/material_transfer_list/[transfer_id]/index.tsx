...
const index = () => {
    ...
    const breadcrumbItems = [
        { label: 'Material Transfer List', url: '/purchase_order/material_transfer_list/' },
        { label: 'Material Transfer Details', url: `/purchase_order/material_transfer_list/${transfer_id}` },
    ]
