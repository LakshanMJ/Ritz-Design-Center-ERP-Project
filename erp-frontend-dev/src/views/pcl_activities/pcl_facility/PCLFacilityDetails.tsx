...
import EditPCLInformation from '../finance/EditPCLInformation';
import PCLOrderProfitabilityDetails from '../finance/PCLOrderProfitabilityDetails';
import PCLOpenGanttChart from '../finance/PCLOpenGanttChart';

const PCLFacilityDetails = ({ pclDetailId }: any) => {
...
export default PCLFacilityDetails;